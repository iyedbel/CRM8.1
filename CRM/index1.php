                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo '<a class="btn btn-danger py-1 px-2 rounded-md bg-red-500 text-white hover:bg-red-600" href="/CRM/delete.php?id=' . $row["id"] . '" onclick="return confirmDelete()">Supprimer</a>';
                            echo '</div>';
                            echo "</td>";
                            echo "</tr>";
                            $count++;
